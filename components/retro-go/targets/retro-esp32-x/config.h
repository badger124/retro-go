// Target definition
#define RG_TARGET_NAME             "RETRO-ESP32-X"
...
// I2C BUS (shared by cartridge slot and optional peripherals)
// GPIO16 = SDA, GPIO17 = SCL are routed to the cartridge expansion connector
#define RG_GPIO_I2C_SDA             GPIO_NUM_16
#define RG_GPIO_I2C_SCL             GPIO_NUM_17

// Cartridge slot hardware module support
// Enables runtime detection of I2C-based sensor/expansion modules
// connected through the Game Boy cartridge-style slot on the back housing
#define RG_CARTRIDGE_MODULE_ENABLED 1
